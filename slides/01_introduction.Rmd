...
```{r landscape, echo=FALSE, out.width = "90%", fig.align='center', purl=FALSE, fig.cap="'Big Data Landscape (2020)', source: http://mattturck.com"}
include_graphics("../img/2020-Data-and-AI-Landscape-Preview-1.png")
```
...
- You will be working in *groups of three (or two)* and conduct a *big data analytics project*.
...
<center> *Register your group here: * </center>
<center> *Hand in on:* </center>
...
<center> *Session 1: TBA* </center>
<center> *Session 2: TBA* </center>
...
[Schwabish, Jonathan A. (2014): An Economist's Guide to Visualizing Data.Journal of Economic Perspectives. 28(1):209‐234.](https://pubs.aeaweb.org/doi/pdfplus/10.1257/jep.28.1.209)
...
- [github.com/lgrigoryeva/bigdata-lecture](https://github.com/lgrigoryeva/bigdata-lecture)
<!-- - [StudyNet/Canvas]() -->
...
# import/inspect data
ga <- read.csv("https://bda-examples.s3.eu-central-1.amazonaws.com/ga.csv")
kable(head(ga))
